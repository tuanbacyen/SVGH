...
namespace SVGH
{
    ...
    {
        private static string con_str = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + System.IO.Path.GetDirectoryName(Assembly.GetEntryAssembly().Location) + "\\database.mdb; Persist Security Info=False;";
